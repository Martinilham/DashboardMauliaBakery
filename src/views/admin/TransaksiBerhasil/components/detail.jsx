      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div className="p-4">
          ...
          <div className="mb-4">
            ...
            >Pembayaran</button> 
            : 
            <button className="cursor-not-allowed mx-auto mt-4 linear rounded-[20px] bg-green-500 px-4 py-2 text-base font-medium text-white transition duration-200 hover:bg-green-500 active:bg-green-500 dark:bg-green-500 dark:hover:bg-green-500dark:active:opacity-90">Lunas</button>
          }
          {statusditerima == "processing" ? 
            ...
            >DiTerima</button> 
            : 
            <button className=" cursor-not-allowed mx-auto mt-4 linear rounded-[20px]  bg-green-500 px-4 py-2 text-base font-medium text-white transition duration-200 hover:bg-green-500 active:bg-green-500 dark:bg-green-500 dark:hover:bg-green-500dark:active:opacity-90">Diterima</button>
          }
          {/* <button className="mx-auto mt-4 linear rounded-[20px] bg-red-500 px-4 py-2 text-base font-medium text-white transition duration-200 hover:bg-red-500 active:bg-red-500 dark:bg-red-500 dark:hover:bg-red-500 dark:active:opacity-90"
